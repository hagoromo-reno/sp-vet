...
export const PHARMACOLOGY_EXPECTATIONS: MedicationValidationSpec[] = [
  ...
  },
  {
    ...
    clinicalClass: 'Vasodilatador balanceado doador de óxido nítrico',
    mechanism: 'Libera NO, ativa guanilato ciclase e eleva GMPc no músculo liso vascular; reduz rapidamente pré-carga, pós-carga e PAM, com risco de hipotensão e toxicidade por cianeto/tiocianato em exposição alta ou prolongada.',
    expectedDoseResponse: dose('Vasodilatação titulável discreta.', 'Redução rápida e controlável da PAM.', 'Vasodilatação intensa; faixa agressiva que exige pressão contínua e vigilância metabólica.'),
    signals: [],
    relativeTrends: [{ metric: 'map', direction: 'decrease', minimumFraction: 0.08 }],
    context: 'toxicology',
    speciesNotes: {
      canine: 'Iniciar baixo e titular; doses altas são agressivas.',
      feline: 'Limite superior menor e resposta titulada sob monitorização contínua.',
    },
    evidence: ['Merck Veterinary Manual: Cardiac Medications of Dogs and Cats', 'ACVIM-2018-systemic-hypertension'],
  },
  {
    drugId: 'hydralazine',
    clinicalClass: 'Vasodilatador arteriolar direto',
    mechanism: 'Relaxamento arteriolar direto reduz resistência vascular sistêmica e pós-carga; a resposta é mais lenta, prolongada e menos previsível que a do nitroprussiato, podendo causar taquicardia reflexa.',
    expectedDoseResponse: dose('Redução pressórica gradual discreta.', 'Redução relevante de pós-carga e PAM.', 'Maior risco de hipotensão prolongada e taquicardia reflexa.'),
    signals: [],
    relativeTrends: [{ metric: 'map', direction: 'decrease', minimumFraction: 0.05 }],
    context: 'healthy',
    speciesNotes: {
      canine: 'Regime injetável modelado a partir de uso agudo com titulação.',
      feline: 'Não disponibilizado no simulador: referências usam dose total por gato SC, incompatível com prescrição automática mg/kg.',
    },
    evidence: ['Merck Veterinary Manual: Initial Triage and Resuscitation', 'PMID:36579333'],
  },
  {
    drugId: 'fluid_lrs',
